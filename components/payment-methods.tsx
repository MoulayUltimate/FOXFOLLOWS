export function PaymentMethods({ className = "" }: { className?: string }) {
    return (
        <div className={`flex flex-wrap items-center justify-center gap-2 ${className}`}>
            {/* Stripe */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-[#635BFF]">
            ...
            {/* AMEX */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-[#006FCF]">
                <span className="text-xs font-bold text-white tracking-wide">AMEX</span>
            </div>

            {/* Mastercard */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-white border border-gray-200">
            ...
            {/* Klarna */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-[#FFB3C7]">
                <span className="text-[10px] font-bold text-black">Klarna.</span>
            </div>

            {/* Bitcoin */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-[#F7931A] border border-gray-200">
                <svg viewBox="0 0 24 24" className="h-4 w-auto fill-white" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* OPay */}
            <div className="flex h-8 w-14 items-center justify-center rounded-md bg-[#6C5CE7]">
